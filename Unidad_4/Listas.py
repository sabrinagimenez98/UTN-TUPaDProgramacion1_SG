...
favoritos = ['chocolate', 'handball', 'bailar', 'playa', 'gatos']
print(f"El penúltimo elemento es: {favoritos[-2]}")
...
print(f"Lista final: {lista_vacia}")
...
print(numeros)
print("El programa remove el valor maximo de la lista")
